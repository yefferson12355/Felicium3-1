...
const SolicitudesPendientes = () => {
  const [solicitudes, setSolicitudes] = useState([
    { 
      id: 1, 
      tipo: 'Solicitud o cambio hora', 
      autor: 'doctor_o_recepcionista',
      fecha: '10 Nov 2025', 
      mensaje: '¿Puedo cambiar mi cita del viernes por la mañana?',
      abierto: true
    },
    { 
      id: 2, 
      ...
      autor: 'doctor_o_recepcionista',
      fecha: '12 Nov 2025', 
      mensaje: 'Necesito una cita para una revisión.',
      abierto: false
    }
  ]);

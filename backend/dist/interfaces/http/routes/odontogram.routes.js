...
exports.createOdontogramRoutes = createOdontogramRoutes;
 ...
 */
function createOdontogramRoutes(controller) {
     ...
     */
    router.get('/patient/:patientId', (req, res) => controller.getOdontogramByPatient(req, res));
    /**

...
exports.CreateOdontogramUseCase = void 0;
const odontogram_entity_1 = require("../../domain/odontogram/odontogram.entity");
/**
...
class CreateOdontogramUseCase {
    ...
    async execute(params) {
        ...
        const existingOdontogram = await this.odontogramRepository.findByPatientId(params.patientId);
        if (existingOdontogram) {
            throw new Error(`El paciente ${params.patientId} ya tiene un odontograma registrado`);
        }
        // 2. Validar edad
        ...
        const odontogram = new odontogram_entity_1.Odontogram(odontogramId, params.patientId, params.patientAge, params.dentureType);
        // 5. Guardar en la BD
        const savedOdontogram = await this.odontogramRepository.save(odontogram);
        return savedOdontogram;
    }
}
exports.CreateOdontogramUseCase = CreateOdontogramUseCase;
